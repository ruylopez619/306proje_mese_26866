...
<br>
<br>
    <img src="background_img.jpg" alt="THIS IS MY CUTE CAT!" height="500" width="1000">
</a>
<?php 
...
<a href="http://localhost/myrecit/admin.php" target="_blank">
    <img src="del.jpg" alt="THIS IS MY CUTE CAT!" height="100" width="200">
</a>
<h3 style="border:10px solid #851195;">Press the photo to delete book from library database</h1>
</div>
</body>
</html>